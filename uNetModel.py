...
class UNet(nn.Module):
    def __init__(self):
        ...
        self.conv63 = nn.Conv2d(in_channels = 64, out_channels = 64, kernel_size = 3, padding = pad, groups = 2)
        ...
        self.conv73 = nn.Conv2d(in_channels = 32, out_channels = 32, kernel_size = 3, padding = pad, groups = 2)
        ...
        self.conv83 = nn.Conv2d(in_channels = 16, out_channels = 16, kernel_size = 3, padding = pad, groups = 2)
        ...
        self.conv93 = nn.Conv2d(in_channels = 8, out_channels = 8, kernel_size = 3, padding = pad, groups = 2)
